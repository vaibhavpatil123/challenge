...
public class Notification {
    ...
    public Notification(Account account, BigDecimal amount, String transactionId, TransactionStatus transactionStatus) {
    ...
    public String toString() {
        return "Notification{" + "account=" + account + ", amount=" + amount + ", transactionId='" + transactionId
               + '\'' + ", transactionDetails='" + transactionDetails + '\'' + ", transactionDate='" + transactionDate
